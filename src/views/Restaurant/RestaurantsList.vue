                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="restaurant in paginatedRestaurants" :key="restaurant.id" class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500 capitalize">{{ restaurant.user }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
...
<script setup>
    ...
    const restaurants = ref([
        ...
        { id: 3, name: 'Gustosa Pasta', user: 'Restaurant owner', status: 'Active' },
        { id: 4, name: 'Burger King', user: 'restaurant owner', status: 'Active' },
        { id: 5, name: 'McDonalds', user: 'restaurant owner', status: 'Active' },
        { id: 6, name: 'Starbucks', user: 'restaurant owner', status: 'Active' },
        { id: 7, name: 'Mr Beast Burger', user: 'restaurant owner', status: 'Active' },
        { id: 8, name: "Sultan's Dine", user: 'restaurant owner', status: 'Active' },
