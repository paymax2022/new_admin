            ...
            <div class="datatable invoice-table">
                ...
                >
                    ...
                    <template #status="data">
                        <span class="badge" :class="[data.value.status.toLowerCase() === 'Pending' ? 'badge-outline-success' : 'badge-outline-danger']">{{
                            data.value.status
                        }}</span>
                    </template>
...
<script lang="ts" setup>
    ...
    const search = ref('');
    const cols = ref([
        { field: 'invoice', title: 'ID' },
        { field: 'name', title: 'Name' },
        { field: 'email', title: 'Guest' },
        { field: 'merchant', title: 'Merchant' },
        { field: 'table', title: 'Table' },
        { field: 'date', title: 'Date' },
        { field: 'status', title: 'Request' },
