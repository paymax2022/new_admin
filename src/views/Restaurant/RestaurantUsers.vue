...
<script setup>
    ...
    const users = ref([
        ...
        { id: 3, name: 'Robert Johnson', email: 'robert.j@example.com', phone: '(345) 678-9012', role: 'Staff', status: 'Inactive' },
        { id: 4, name: 'Emily Davis', email: 'emily.d@example.com', phone: '(456) 789-0123', role: 'Staff', status: 'Active' },
        { id: 5, name: 'Michael Wilson', email: 'michael.w@example.com', phone: '(567) 890-1234', role: 'Manager', status: 'Active' },
        { id: 6, name: 'Sarah Brown', email: 'sarah.b@example.com', phone: '(678) 901-2345', role: 'Staff', status: 'Inactive' },
        { id: 7, name: 'David Taylor', email: 'david.t@example.com', phone: '(789) 012-3456', role: 'Staff', status: 'Active' },
        { id: 8, name: 'Jessica Clark', email: 'jessica.c@example.com', phone: '(890) 123-4567', role: 'Staff', status: 'Active' },
        { id: 9, name: 'Thomas White', email: 'thomas.w@example.com', phone: '(901) 234-5678', role: 'Manager', status: 'Active' },
        { id: 10, name: 'Lisa Hall', email: 'lisa.h@example.com', phone: '(012) 345-6789', role: 'Staff', status: 'Inactive' },
    ]);
    ...
    const pagination = computed(() => {
        ...
        const endIndex = Math.min(startIndex + perPage.value, filteredUsers.value.length);
        return { startIndex, endIndex };
    });

    const paginatedUsers = computed(() => {
        return filteredUsers.value.slice(pagination.value.startIndex, pagination.value.endIndex);
    });
