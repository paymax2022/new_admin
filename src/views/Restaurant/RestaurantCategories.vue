                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="restaurant in paginatedRestaurants" :key="restaurant.id" class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500 capitalize">{{ restaurant.created_by }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr v-if="filteredRestaurants.length === 0">
                            <td colspan="4" class="px-6 py-4 text-center text-sm text-gray-500">No restaurants found</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<script setup>
    ...
    const restaurants = ref([
        ...
        { id: 2, name: 'Wham! Bam! Burrito', created_by:  'Restaurant owner', status: 'Active' },
        { id: 3, name: 'Gustosa Pasta', created_by:  'Restaurant owner', status: 'Active' },
        { id: 4, name: 'Burger King', created_by:  'restaurant owner', status: 'Active' },
        { id: 5, name: 'McDonalds', created_by: 'restaurant owner', status: 'Active' },
        { id: 6, name: 'Starbucks', created_by: 'restaurant owner', status: 'Active' },
        { id: 7, name: 'Mr Beast Burger',created_by:  'restaurant owner', status: 'Active' },
        { id: 8, name: "Sultan's Dine",created_by: 'restaurant owner', status: 'Active' },
        // Add more sample data to test pagination
        ...Array.from({ length: 12 }, (_, i) => ({ id: i + 9, name: `Restaurant ${i + 9}`, user: 'restaurant owner', status: 'Active' })),
    ]);
    ...
    const filteredRestaurants = computed(() => {
        ...
        return restaurants.value.filter(
            (restaurant) =>
                ...
                restaurant.user.toLowerCase().includes(query) ||
