          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="event in events" :key="event.id">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <span :class="event.repetitive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'"
                      class="px-2 py-1 text-xs font-medium rounded-full">
                  {{ event.repetitive ? 'Yes' : 'No' }}
                </span>
              </td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <span :class="event.featured ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'"
                      class="px-2 py-1 text-xs font-medium rounded-full">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <span :class="event.status === 'Enabled' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'"
                      class="px-2 py-1 text-xs font-medium rounded-full">
                  {{ event.status }}
                </span>
              </td>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                ...
                <div class="mt-1">
                  <button class="text-sm text-purple-600 hover:text-purple-900">
                    Export Attendees ({{ event.attendees }})
                  </button>
                </div>
              </td>
            </tr>
