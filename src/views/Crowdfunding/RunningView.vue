<template>
    <div class="md:p-6 p-4">
        ...
        <div class="lg:flex lg:justify-between lg:py-2">
            ...
            <div>
                <button @click="showModal = true" class="border border-indigo-600 bg-indigo-600 text-white px-4 py-2 rounded-md">Feature it</button>
            </div>
        </div>
        ...
        <div v-if="showModal" class="fixed inset-0 z-50 flex items-start justify-center p-4 pt-24 bg-black bg-opacity-50">
            <div class="bg-white w-full max-w-md rounded-lg shadow-lg overflow-hidden">
                ...
                <!-- Modal Body -->
                <div class="px-6 py-4 border-b border-gray-200">
                    <p class="text-gray-700 text-sm">Are you sure to feature this campaign?</p>
                </div>
        ...
        <div class="space-y-8">
            ...
            <div v-if="activeTab === 'donation'">
                ...
                <div class="mt-16">
                    ...
                    <div class="flex justify-end mt-4" ><button   class="border border-indigo-600 text-indigo-600 px-4 py-2 rounded-md">View All</button></div>
                </div>
            </div>
