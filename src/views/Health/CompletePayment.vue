            ...
            <table class="table-auto w-full border-collapse border border-gray-300">
                <thead class="bg-gray-300">
                    <tr>
                        ...
                        <th class="px-4 py-2 border border-gray-300 text-left">Transaction ID</th>
                    </tr>
                </thead>
                <tbody>
                    <template v-if="paginatedData.length">
                        <template v-for="data in paginatedData" :key="data.id">
                            <tr class="even:bg-gray-50">
                                ...
                                <td class="px-4 py-2 border border-gray-300">{{ data.transactionId }}</td>
                            </tr>
                        </template>
                    </template>
                    <tr v-else>
...
<script lang="ts" setup>
    ...
    const tableData = ref([
        { id: 1, name: 'John Doe', date: '2024-02-15 19:21:26', amount: '100', transactionId: '986765432' },
        { id: 2, name: 'Jane Smith', date: '2024-02-15 19:21:26', amount: '100', transactionId: '986765432' },
        { id: 3, name: 'Alice Brown', date: '2024-02-15 19:21:26', amount: '100', transactionId: '986765432' },
        { id: 4, name: 'Charlie White', date: '2024-02-15 19:21:26', amount: '100', transactionId: '986765432' },
        { id: 5, name: 'Eve Green', date: '2024-02-15 19:21:26', amount: '100', transactionId: '986765432' },
        { id: 6, name: 'Mike Black', date: '2024-02-15 19:21:26', amount: '100', transactionId: '986765432' },
    ]);
