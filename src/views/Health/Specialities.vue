...
<script lang="ts" setup>
    ...
    const specialties = ref<Specialty[]>([
        { id: '#01', name: 'Cardiology', image: '/icons/cardiology.png' },
        { id: '#02', name: 'Neurology', image: '/icons/neurology.png' },
        { id: '#03', name: 'Orthopedics', image: '/icons/orthopedics.png' },
    ]);
    ...
    const newSpecialty = ref<Specialty>({ id: '', name: '', image: null });
    ...
    function openAddSpecialistModal() {
        newSpecialty.value = { id: `#${specialties.value.length + 1}`, name: '', image: null };
    ...
    function addSpecialty() {
        if (newSpecialty.value.name && newSpecialty.value.image) {
    ...
    // Handle image upload
    function handleImageUpload(event: Event, type: 'add' | 'edit') {
        ...
        if (file) {
            ...
            reader.onload = () => {
                ...
                } else if (type === 'edit' && editableSpecialty.value) {
