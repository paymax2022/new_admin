    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center px-4 py-8">
      ...
      <div class="relative z-10 w-full max-w-md rounded-3xl bg-white shadow-[0_40px_80px_rgba(15,23,42,0.18)]">
        <header class="flex items-center justify-between border-b border-[#e2e8f0] px-8 py-6">
          <h2 class="text-xl font-semibold text-[#111827]">Pause Election</h2>
          <button
            type="button"
        ...
        <div class="px-8 py-6">
          <p class="text-sm text-[#475569] leading-relaxed">
            Are you sure you want to pause <span class="font-semibold text-[#111827]">"{{ election?.title || '' }}"</span>? This will prevent voters from casting any new votes until the election is resumed.
          </p>
        </div>
