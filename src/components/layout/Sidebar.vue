                    ...
                    <ul class="relative font-semibold space-y-0.5 p-4 py-0">
                        ...
                        <vue-collapsible :isOpen="activeDropdown === 'dashboard'">
                            <ul class="sub-menu text-gray-500">
                                ...
                                <li>
                                    <router-link to="/analytics" @click="toggleMobileMenu">{{ $t('Restaurant')
                                        }}</router-link>
                                </li>
                                <li>
                                    <router-link to="/finance" @click="toggleMobileMenu">{{ $t('Voting')
                                        }}</router-link>
                                </li>
                                <li>
                                    <router-link to="/crypto" @click="toggleMobileMenu">{{ $t('Visitor')
                                        }}</router-link>
                                </li>
                                <li>
                                    <router-link to="/crypto" @click="toggleMobileMenu">{{ $t('Delivery')
                                        }}</router-link>
                                </li>
                                <li>
                                    <router-link to="/crypto" @click="toggleMobileMenu">{{ $t('Group Membership')
                                        }}</router-link>
                                </li>
                                <li>
