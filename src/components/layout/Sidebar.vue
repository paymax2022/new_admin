                        ...
                        <li class="menu nav-item">
                            <router-link :to="{ name: 'profile' }" class="nav-link group" @click="toggleMobileMenu">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('profile') }}</span>
                                </div>
                            </router-link>
                        </li>
...
<script lang="ts" setup>
    ...
    import HealthNavigation from '../modules/Health/HealthNavigation.vue';
